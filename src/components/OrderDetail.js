...
export default function OrderDetail() {
    ...
    const {id} = useParams();
    const { orderDetail, loading,user={}, 
    orderStatus="Processing", 
    orderItems=[], 
    totalPrice=0,
    shippingInfo={}, 
    paymentInfo={} } = useSelector(state => state.orderState)
 ...
 console.log(orderDetail.totalPrice)
    return ( 
        ...
        //                     <p className="mb-4"><b>Address:</b>{shippingInfo.address}, {shippingInfo.city}, {shippingInfo.state}, {shippingInfo.postalCode},{shippingInfo.state},{shippingInfo.country}</p>
